...
const NR_FR1_BW_MHZ = [5, 10, 15, 20, 30]      // n254 / n255 / n256（L/S）
const NR_FR2_BW_MHZ = [50, 100, 200, 400]      // n510 / n511 / n512（Ka）
...
const NB_TBS_DL = [   // NPDSCH Table 16.4.1.5.1-1，列 I_SF 0–7 ↔ N_SF = 1,2,3,4,5,6,8,10
...
const NB_TBS_UL = [   // NPUSCH Table 16.5.1.2-2，列 I_RU 0–7 ↔ N_RU = 1,2,3,4,5,6,8,10
  [16, 32, 56, 88, 120, 152, 208, 256],
  [24, 56, 88, 144, 176, 208, 256, 344],
  [32, 72, 144, 176, 208, 256, 328, 424],
  [40, 104, 176, 208, 256, 328, 440, 568],
...
// ===== NR =====
function nrRbTable(scs) { return NR_RB_TABLE[Number(scs)] || null }
...
module.exports = {
  MU_OF, NR_RB_TABLE, NR_FR1_BW_MHZ, NR_FR2_BW_MHZ, TBS_QUANT, NB_TBS_DL, NB_TBS_UL, NB_SF_COUNT, NB_ST_MCS,
  NB_NREP_DL, NB_NREP_UL, NR_NREP_MAX_UL, NR_NREP_MAX_DL, nRepError,
  MCS_TABLE_SHORT, MCS_TABLE_ZH,
  normalizePhy, nrRbTable, nrMaxRb, nrOccupiedBwKHz, nrChannelBwKHz, nrTbsPerSlot, nrInfoRateKbps,
