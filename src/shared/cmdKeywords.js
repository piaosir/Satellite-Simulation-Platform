...
export const CMD_KW = {
  ...
  '卫星信息栏': ['satellite info', 'info panel', 'inspector', 'properties', 'right panel', '信息卡', '卫星信息', '属性', '右栏', '右侧栏', '详情'],
  ...
  '发送覆盖图到小程序…': ['miniapp', 'wechat', 'share', 'upload', 'coverage', '微信', '小程序', '分享', '上传', '密钥', '覆盖', '多边形'],
  '发送航迹到小程序…': ['miniapp', 'wechat', 'share', 'track', 'trajectory', 'route', '微信', '小程序', '分享', '密钥', '航迹', '轨迹', '航行', '飞行', '船', '飞机'],
...
export const ID_KW = {
  ...
  'sec.bs-stk': ['gaussian', 'STK', 'pattern', '高斯', '方向图', '口径', '波束宽', '峰值增益', '效率'],
  ...
  // 星座地图页登记的动作与图层开关
  'const.wizard': ['walker', 'constellation', 'generate', 'orbit wizard', 'sun sync', 'sun synchronous', 'repeating',
    'molniya', 'geosynchronous', 'critically inclined', '星座生成器', '新建星座', '轨道面',
    '轨道向导', '太阳同步', '回归', '回归轨道', '地球同步', '临界倾角', '单星'],
  ...
  'const.filter': ['filter', 'satcat', 'catalog', 'owner', 'object type', 'status', 'launch year', 'orbit regime',
    '筛选', '过滤', '编目', '所有者', '对象类型', '运行状态', '发射年', '轨道区制', '倾角', '周期'],
