...
export const LB_DOC_EN = {
  ...
  '本链路无可绘制的几何': 'No geometry can be drawn for this link',
  '缺少发信站经纬度': 'transmit-station longitude/latitude unavailable',
  '缺少收信站经纬度': 'receive-station longitude/latitude unavailable',
  '缺少卫星定点轨道经度': 'satellite orbital longitude unavailable',
  '缺少卫星星下点': 'satellite sub-point unavailable',
  '缺少轨道高度': 'orbit altitude unavailable',
  '缺少轨道高度或最差仰角': 'orbit altitude or worst-case elevation unavailable',
  '缺少两星的星下点': 'sub-points of the two satellites unavailable',
  '星间几何不可解（两星互不可见或缺相位）': 'ISL geometry unsolvable (satellites not mutually visible, or phase missing)',

  // —— 状态与提示（引擎抛回来的消息不在字典里，原样透出）——
  '尚无计算结果': 'No computation result yet',
