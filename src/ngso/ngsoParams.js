...
export const FIELD_GROUPS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'orbitAltitude', label: '轨道高度', tip: '圆轨道高度；选星（天线树导入/搜索）后由所选卫星轨道自动确定，只读', unit: 'km', type: 'num', def: '1145', target: 'link', pair: 'orbit' },
      { key: 'orbitInclination', label: '轨道倾角', tip: '轨道倾角；选星后由所选卫星轨道根数自动确定，只读', unit: '°', type: 'num', def: '53', target: 'sat', pair: 'orbit' },
