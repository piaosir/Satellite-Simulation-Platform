...
export const CUSTOMIZABLE_DISPUTES = [
  { key: 'kashmir', zh: '克什米尔（印巴）', en: 'Kashmir (India–Pakistan)', units: ['IN-PK-KAS', 'PK-AZK', 'PK-GB', 'KAS', 'KAS-SIA'], opts: ['IND', 'PAK', 'disputed'] },
  { key: 'aksai-chin', zh: '阿克赛钦', en: 'Aksai Chin', units: ['CN-AKS', 'CN-SHK'], opts: ['CHN', 'IND', 'disputed'] },
  { key: 'arunachal', zh: '藏南（阿鲁纳恰尔）', en: 'South Tibet / Arunachal Pradesh', units: ['IN-ARP', 'IN-CN-DMC', 'IN-CN-SMD', 'IN-CN-TRP', 'IN-CN-BRH'], opts: ['CHN', 'IND', 'disputed'] },
  ...
  { key: 'transnistria', zh: '德涅斯特河沿岸', en: 'Transnistria', units: ['MD-TRA'], opts: ['MDA', 'disputed'] },
  { key: 'artsakh', zh: '纳戈尔诺-卡拉巴赫', en: 'Nagorno-Karabakh', units: ['AZ-ART'], opts: ['AZE', 'disputed'] },
